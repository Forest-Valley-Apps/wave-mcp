    ...
    this.server = new Server(
      ...
      },
      {
        ...
        instructions: [
          ...
          '- All wave_*_transaction* tools: no transaction reads, no update/categorize mutations;',
          '  the only write is the beta moneyTransactionCreate (blind write, no read-back).',
